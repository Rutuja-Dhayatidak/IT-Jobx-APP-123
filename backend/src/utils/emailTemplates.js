    ...
    html: `
      <div style="font-family: sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
        <div style="text-align: center; margin-bottom: 20px;">
           <h1 style="color: #10b981; margin: 0;">ITjobx</h1>
        ...
        <p>You have been invited to join the <strong>ITjobx Job Portal</strong> as a <span style="background-color: #f0fdf4; color: #10b981; padding: 4px 8px; border-radius: 4px; font-weight: bold; border: 1px solid #10b981;">${role}</span>.</p>
        ...
        <p style="font-size: 14px; color: #1a2e24;">Regards,<br><strong>ITjobx Administrative Team</strong></p>
      </div>
    `,
  };
